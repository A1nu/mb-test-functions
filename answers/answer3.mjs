...
/**
 Write a function (say fruitPresent('fruit-name') )to find out if a given input is present in the array below using ES6
...
e.g. -
fruitPresent('apple') should return true fruitPresent('artichoke') should return false
 **/
